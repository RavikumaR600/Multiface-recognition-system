...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'ranjan.amresh100@gmail.com' ")
...
def change_pass():
    ...
    cancel = tk.Button(master, text="Cancel", command=master.destroy, fg="white", bg="blue",
                       height=1, width=25, activebackground="white", font=('times', 10, ' bold '))
    cancel.place(x=200, y=120)
    save1 = tk.Button(master, text="Save", command=save_pass, fg="white", bg="purple",
                      height=1, width=25, activebackground="white", font=('times', 10, ' bold '))
...
window.iconphoto(False, tk.PhotoImage
    (file='C:/Users/Dell/Desktop/Multi-Face-Recognition-Based-Detect-System-main/facial-recognition.png'))
...
message3 = tk.Label(window, text="Multi-Face Recognition Based Detect System",
...
lbl = tk.Label(frame2, text="Enter ID(Numeric Values)", width=20,
               height=1, fg="black", bg="#00aeff", font=('times', 17, ' bold '))
lbl.place(x=80, y=55)

txt = tk.Entry(frame2, width=32, fg="black", font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Your Name", width=20,
...
message1 = tk.Label(frame2, text="1)Ready for Take Images  >>>  2)Save Profile", bg="#00aeff",
...
lbl3 = tk.Label(frame1, text="Total Detections Shows!", width=20,
                fg="white", bg="#00aeff", height=1, font=('times', 17, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="white",
                        bg="black", width=11, activebackground="white", font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="white",
                         bg="green", width=11, activebackground="white", font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)
takeImg = tk.Button(frame2, text="Take Images Now", command=TakeImages, fg="white",
                    bg="blue", width=34, height=1, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Your Profile", command=psw, fg="white", bg="purple",
                     width=34, height=1, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Recognizes Your Faces Now", command=TrackImages, fg="black",
